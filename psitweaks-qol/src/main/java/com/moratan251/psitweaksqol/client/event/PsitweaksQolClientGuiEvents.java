...
public final class PsitweaksQolClientGuiEvents {
    ...
    public static void register(IEventBus eventBus) {
        eventBus.addListener(PsitweaksQolClientGuiEvents::onScreenRenderPost);
        eventBus.addListener(PsitweaksQolClientGuiEvents::onKeyPressedPre);
        eventBus.addListener(PsitweaksQolClientGuiEvents::onCharacterTypedPre);
        eventBus.addListener(PsitweaksQolClientGuiEvents::onMouseButtonPressedPre);
        eventBus.addListener(PsitweaksQolClientGuiEvents::onMouseButtonPressedPost);
        eventBus.addListener(PsitweaksQolClientGuiEvents::onMouseDraggedPre);
        eventBus.addListener(PsitweaksQolClientGuiEvents::onMouseButtonReleasedPre);
        eventBus.addListener(PsitweaksQolClientGuiEvents::onMouseScrolledPre);
        eventBus.addListener(PsitweaksQolClientGuiEvents::onScreenClosing);
    }

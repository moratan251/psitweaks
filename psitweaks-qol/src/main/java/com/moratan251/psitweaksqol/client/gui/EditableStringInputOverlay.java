...
public final class EditableStringInputOverlay {
    ...
    private static void drawText(
        ...
        if (value.isEmpty()) {
            scrollLineOffset = 0;
            Component emptyText = Component.translatable("psitweaks_qol.gui.string_constant_input.empty");
        ...
        Component hint = Component.translatable(screen.isSpectator()
                ? "psitweaks_qol.gui.string_constant_input.read_only"
                : "psitweaks_qol.gui.string_constant_input.hint");
    ...
    private enum ActionButton {
        COPY_ALL("psitweaks_qol.gui.string_constant_input.button.copy_all", false),
        CLEAR_ALL("psitweaks_qol.gui.string_constant_input.button.clear_all", true),
        REPLACE_ALL("psitweaks_qol.gui.string_constant_input.button.replace_all", true);

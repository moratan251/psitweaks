...
public final class TunnelerAndBucketGameTests {
    ...
    public static void tunnelerPiercesPoweredWither(GameTestHelper helper) {
        ...
        var source = new net.minecraft.world.damagesource.DamageSource(level.registryAccess().registryOrThrow(net.minecraft.core.registries.Registries.DAMAGE_TYPE).getHolderOrThrow(PsitweaksDamageTypes.TUNNELER), tunneler, owner);

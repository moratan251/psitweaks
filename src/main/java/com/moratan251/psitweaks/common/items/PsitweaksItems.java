...
public class PsitweaksItems {
   ...
   // public static final RegistryObject<Item> TEST_ITEM = ITEMS.register("test_item", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> PROGRAM_IDEA_STORAGE = ITEMS.register("program_idea_storage", () -> new ItemPsitweaksProgram(new Item.Properties().rarity(Rarity.UNCOMMON).stacksTo(1), false));
    ...
    public static final RegistryObject<Item> QUANTUM_FACTOR = ITEMS.register("quantum_factor", () -> new ItemQuantumFactor(new Item.Properties()));
    public static final RegistryObject<Item> GRAVITON_FACTOR = ITEMS.register("graviton_factor", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> HARDENED_CAPSULE = ITEMS.register("hardened_capsule", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> FLASH_COIL = ITEMS.register("flash_coil", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> FLASH_CHIP = ITEMS.register("flash_chip", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> NANO_REACTOR = ITEMS.register("nano_reactor", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> STRING_A = ITEMS.register("string_a", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> QUANTIZED_PLATE = ITEMS.register("quantized_plate", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> GRAVITIZED_PLATE = ITEMS.register("gravitized_plate", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> UNFATHOMABLE_COMPONENT = ITEMS.register("unfathomable_component", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> PHOTON_GLITTER = ITEMS.register("photon_glitter", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> CLUMP_ANTINITE = ITEMS.register("clump_antinite", () -> new Item(new Item.Properties()));

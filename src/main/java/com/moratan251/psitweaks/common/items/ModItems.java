...
public class ModItems {
   ...
   // public static final RegistryObject<Item> TEST_ITEM = ITEMS.register("test_item", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> MOVAL_SUIT_HELMET = ITEMS.register("moval_suit_helmet",
            () -> new ItemMovalSuitHelmet(ItemMovalSuitArmor.MOVAL_SUIT_MATERIAL,ArmorItem.Type.HELMET, new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<Item> MOVAL_SUIT_CHESTPLATE = ITEMS.register("moval_suit_chestplate",
            () -> new ItemMovalSuitChestplate(ItemMovalSuitArmor.MOVAL_SUIT_MATERIAL,ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<Item> MOVAL_SUIT_LEGGINGS = ITEMS.register("moval_suit_leggings",
            () -> new ItemMovalSuitLeggings(ItemMovalSuitArmor.MOVAL_SUIT_MATERIAL,ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<Item> MOVAL_SUIT_BOOTS = ITEMS.register("moval_suit_boots",
            () -> new ItemMovalSuitBoots(ItemMovalSuitArmor.MOVAL_SUIT_MATERIAL,ArmorItem.Type.BOOTS, new Item.Properties().rarity(Rarity.EPIC)));

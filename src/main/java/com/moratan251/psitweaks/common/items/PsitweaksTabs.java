    ...
    public static final RegistryObject<CreativeModeTab> PSITWEAKS_TAB = TABS.register("psitweaks",
            () -> CreativeModeTab.builder().
                    ...
                    displayItems((((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(PsitweaksItems.QUANTUM_FACTOR.get());
                        pOutput.accept(PsitweaksItems.GRAVITON_FACTOR.get());
                        pOutput.accept(PsitweaksItems.HARDENED_CAPSULE.get());
                        pOutput.accept(PsitweaksItems.FLASH_COIL.get());
                        pOutput.accept(PsitweaksItems.FLASH_CHIP.get());
                        pOutput.accept(PsitweaksItems.NANO_REACTOR.get());
                        pOutput.accept(PsitweaksItems.STRING_A.get());
                        pOutput.accept(PsitweaksItems.QUANTIZED_PLATE.get());
                        pOutput.accept(PsitweaksItems.GRAVITIZED_PLATE.get());
                        pOutput.accept(PsitweaksItems.UNFATHOMABLE_COMPONENT.get());
                        pOutput.accept(PsitweaksItems.PHOTON_GLITTER.get());
                        pOutput.accept(PsitweaksItems.WAVE_FRAGMENT.get());
                        pOutput.accept(PsitweaksItems.SUPERSTRING.get());
                        pOutput.accept(PsitweaksItems.QUANTIZE_ARROWHEAD.get());
                        pOutput.accept(PsitweaksItems.TUNNELER.get());
                        pOutput.accept(PsitweaksItems.PSIMETAL_NUGGET.get());
                        pOutput.accept(PsitweaksItems.IVORY_PSIMETAL_NUGGET.get());
                        pOutput.accept(PsitweaksItems.EBONY_PSIMETAL_NUGGET.get());

                        pOutput.accept(PsitweaksItems.CHAOTIC_PSIMETAL.get());
                        pOutput.accept(PsitweaksItems.CHAOTIC_PSIMETAL_NUGGET.get());
                        pOutput.accept(PsitweaksItems.FLASHMETAL.get());
                        pOutput.accept(PsitweaksItems.FLASHMETAL_NUGGET.get());
                        pOutput.accept(PsitweaksItems.HEAVY_PSIMETAL.get());
                        pOutput.accept(PsitweaksItems.HEAVY_PSIMETAL_NUGGET.get());
                        pOutput.accept(PsitweaksItems.ANTINITE_INGOT.get());
                        pOutput.accept(PsitweaksItems.ANTINITE_NUGGET.get());
                        pOutput.accept(PsitweaksItems.PSYCHEONIC_METAL_INGOT.get());
                        pOutput.accept(PsitweaksItems.PSYCHEONIC_METAL_NUGGET.get());
                        ...
                        pOutput.accept(PsitweaksItems.TRANSCENDENT_SPELL_BULLET.get());
                        pOutput.accept(PsitweaksItems.TRANSCENDENT_SPELL_BULLET_LOOP.get());
                        pOutput.accept(PsitweaksItems.TRANSCENDENT_SPELL_BULLET_MINE.get());
                        pOutput.accept(PsitweaksItems.TRANSCENDENT_SPELL_BULLET_CHARGE.get());
                        pOutput.accept(PsitweaksItems.TRANSCENDENT_SPELL_BULLET_GRENADE.get());
                        pOutput.accept(PsitweaksItems.TRANSCENDENT_SPELL_BULLET_PROJECTILE.get());
                        pOutput.accept(PsitweaksItems.TRANSCENDENT_SPELL_BULLET_CIRCLE.get());
                        ...
                        pOutput.accept(PsitweaksItems.PROGRAM_JUMP_FLEX.get());
                        ...
                        pOutput.accept(PsitweaksBlocks.PSYCHEONIC_METAL_BLOCK.get());
                        pOutput.accept(PsitweaksBlocks.PSYCHEONIC_METAL_CRUX.get());
                        pOutput.accept(PsitweaksBlocks.HYPOSTASIS_GEM_BLOCK.get());

...
public final class PsitweaksTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> PSITWEAKS_TAB = TABS.register(
            ...
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(PsitweaksItems.CAD_CORE_ABSORPTIVE.get());
                        output.accept(PsitweaksItems.CAD_CORE_ULTRACLOCKED.get());
                        output.accept(PsitweaksItems.CAD_BATTERY_REACTIVE.get());
                        output.accept(PsitweaksItems.CAD_BATTERY_QUANTUM.get());
    ...
    private static void acceptProgramItems(CreativeModeTab.Output output) {
        ...
        output.accept(PsitweaksItems.PROGRAM_DRY_METEOR.get());
        ...
        output.accept(PsitweaksItems.PROGRAM_IDEA_STORAGE.get());
    }
}

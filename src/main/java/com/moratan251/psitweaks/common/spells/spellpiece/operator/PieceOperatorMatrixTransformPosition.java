...
public class PieceOperatorMatrixTransformPosition extends PieceOperator {
    private SpellParam<MatrixValue> matrix;
    private SpellParam<Vector3> vector;

    public PieceOperatorMatrixTransformPosition(Spell spell) {
        super(spell);
    }
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        return MatrixOperations.transformPosition(mat, vec);
    }

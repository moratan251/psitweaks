...
public class PieceOperatorMatrixMultiply extends PsitweaksPieceOperator {
    private SpellParam<MatrixValue> matrix1;
    private SpellParam<MatrixValue> matrix2;
    private SpellParam<MatrixValue> matrix3;

    public PieceOperatorMatrixMultiply(Spell spell) {
        super(spell);
    }
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        return MatrixOperations.multiply(a, b, c);
    }

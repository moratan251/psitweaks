...
public class PieceOperatorMatrixLinearPart extends PsitweaksPieceOperator {
    private SpellParam<MatrixValue> matrix;

    public PieceOperatorMatrixLinearPart(Spell spell) {
        super(spell);
    }
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        return MatrixOperations.linearPart(getNotNullParamValue(context, matrix));
    }

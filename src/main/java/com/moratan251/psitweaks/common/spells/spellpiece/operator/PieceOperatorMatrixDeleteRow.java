...
public class PieceOperatorMatrixDeleteRow extends PsitweaksPieceOperator {
    private SpellParam<MatrixValue> matrix;
    private SpellParam<Number> row;

    public PieceOperatorMatrixDeleteRow(Spell spell) {
        super(spell);
    }
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        return MatrixOperations.deleteRow(mat, index);
    }

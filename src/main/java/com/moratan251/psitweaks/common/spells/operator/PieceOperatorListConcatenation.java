...
public class PieceOperatorListConcatenation extends PieceOperatorModeListBase {
    private SpellParam<?> list1;
    private SpellParam<?> list2;

    public PieceOperatorListConcatenation(Spell spell) {
        super(spell);
    }
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        return ModeListOperations.concatenation(currentMode(), left, right);
    }

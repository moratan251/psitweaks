...
public class PieceOperatorMatrixDiagonal extends PsitweaksPieceOperator {
    private SpellParam<Object> values;

    public PieceOperatorMatrixDiagonal(Spell spell) {
        super(spell);
    }
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        return MatrixOperations.diagonal(MatrixOperations.asNumberList(getNotNullParamValue(context, values)));
    }

...
public class PieceOperatorStringEquals extends PieceOperator {
    private SpellParam<String> string1;
    private SpellParam<String> string2;

    public PieceOperatorStringEquals(Spell spell) {
        super(spell);
    }
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        return StringSpellHelper.bool(Objects.equals(first, second));
    }

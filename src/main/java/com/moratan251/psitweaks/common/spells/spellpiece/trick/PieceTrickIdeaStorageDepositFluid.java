...
public class PieceTrickIdeaStorageDepositFluid extends PieceTrickIdeaStorageResourceBase {
    public PieceTrickIdeaStorageDepositFluid(Spell spell) { super(spell); }

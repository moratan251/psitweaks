...
public class PieceTrickMolecularDivider extends PieceTrick {
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        spawnTriangleParticles(world, v1, v2, v3);
    ...
    private void spawnTriangleParticles(Level world, Vec3 v1, Vec3 v2, Vec3 v3) {
        if (!(world instanceof ServerLevel serverLevel)) {
            return;
        }

        spawnLineParticles(serverLevel, v1, v2);
        spawnLineParticles(serverLevel, v2, v3);
        spawnLineParticles(serverLevel, v3, v1);
    }
    ...
    private void spawnLineParticles(ServerLevel world, Vec3 start, Vec3 end) {
        ...
        for (double i = 0; i < length; i += 0.5) {
            Vec3 pos = start.add(step.scale(i / 0.5));
            world.sendParticles(

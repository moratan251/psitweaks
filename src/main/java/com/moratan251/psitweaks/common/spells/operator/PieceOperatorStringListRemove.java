...
public class PieceOperatorStringListRemove extends PieceOperator {
    private SpellParam<String> string;
    private SpellParam<StringListWrapper> list;

    public PieceOperatorStringListRemove(Spell spell) {
        super(spell);
    }
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        return StringListWrapper.withRemoved(source, value);
    }

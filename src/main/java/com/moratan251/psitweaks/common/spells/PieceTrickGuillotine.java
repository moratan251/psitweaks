...
public class PieceTrickGuillotine extends PieceTrick {
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        if (damaged && wasAlive && !livingEntity.isAlive()) {
            ...
            if (livingEntity instanceof Villager villager && isSpellcasterVillager(villager)) {
    ...
    private ItemStack createPlayerHead(Player player) {
        ...
        playerHead.set(DataComponents.PROFILE, new ResolvableProfile(player.getGameProfile()));
        return playerHead;
    }
    ...
    private Item resolveMobHeadItem(Mob mob) {
        ...
        Item dynamicHead = BuiltInRegistries.ITEM.get(
        ...
        Item dynamicSkull = BuiltInRegistries.ITEM.get(

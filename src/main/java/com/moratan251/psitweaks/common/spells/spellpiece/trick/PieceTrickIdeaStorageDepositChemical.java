...
public class PieceTrickIdeaStorageDepositChemical extends PieceTrickIdeaStorageResourceBase {
    public PieceTrickIdeaStorageDepositChemical(Spell spell) { super(spell); }

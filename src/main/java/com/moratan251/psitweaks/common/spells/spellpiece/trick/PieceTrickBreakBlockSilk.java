...
public class PieceTrickBreakBlockSilk extends PieceTrick {
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        PieceTrickBreakBlock.removeBlockWithDrops(context, context.caster, level, silkTool, pos, filter);
    ...
    private ItemStack createSilkTool(SpellContext context) throws SpellRuntimeException {
        ...
        Holder<Enchantment> silkTouch = context.caster.level().registryAccess()

...
public class PieceTrickMeltBlock extends PieceTrick {
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        BlockState replacement = getMeltedState(level.getBlockState(pos));
        if (replacement != null) {
    ...
    private static BlockState getMeltedState(BlockState state) {
        ...
        if (state.is(Blocks.OBSIDIAN) || isStoneLike(state) || isCobblestoneLike(state)) {
    ...
    private static boolean isCobblestoneLike(BlockState state) {

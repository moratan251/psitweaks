...
final class JumpAnchorHelper {
    private JumpAnchorHelper() {
    }

    static int findMatchingAnchorOrder(Spell spell, SpellPiece source, String targetLabel)
    ...
    static boolean jumpToMatchingAnchor(SpellContext context, SpellPiece source, String targetLabel)

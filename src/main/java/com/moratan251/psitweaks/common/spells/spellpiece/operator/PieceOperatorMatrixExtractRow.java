...
public class PieceOperatorMatrixExtractRow extends PsitweaksPieceOperator {
    private SpellParam<MatrixValue> matrix;
    private SpellParam<Number> row;

    public PieceOperatorMatrixExtractRow(Spell spell) {
        super(spell);
    }
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        return MatrixOperations.extractRow(mat, index);
    }

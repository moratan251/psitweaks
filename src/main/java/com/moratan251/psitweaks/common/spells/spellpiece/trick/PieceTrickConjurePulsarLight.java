...
public class PieceTrickConjurePulsarLight extends PieceTrick {
    private static final int POTENCY = 60;
    private static final int COST = 210;
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        PulsarConjurationHelper.conjure(context, level, pos, timeValue, pulsarLightState());
        return null;
    }

    private static BlockState pulsarLightState() {
        return PsitweaksBlocks.CONJURED_PULSAR_LIGHT.get().defaultBlockState()
                .setValue(BlockConjured.SOLID, false)
                .setValue(BlockConjured.LIGHT, true);
    }
}

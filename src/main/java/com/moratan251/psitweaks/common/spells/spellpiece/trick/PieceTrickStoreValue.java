...
public class PieceTrickStoreValue extends PieceTrick {
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        CadPlainMemory.store(context, internalSlot, getRequiredValue(context));
        CadPlainMemory.markSlotLocked(context, internalSlot);
        return null;
    }

    private Object getRequiredValue(SpellContext context) throws SpellRuntimeException {
        Object targetValue = getParamValue(context, value);
        if (targetValue == null) {

...
public class EntityMolecularDivider extends Entity {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        builder.define(V1_X, 0.0F);
        builder.define(V1_Y, 0.0F);
        builder.define(V1_Z, 0.0F);
        builder.define(V2_X, 0.0F);
        builder.define(V2_Y, 0.0F);
        builder.define(V2_Z, 0.0F);
        builder.define(V3_X, 0.0F);
        builder.define(V3_Y, 0.0F);
        builder.define(V3_Z, 0.0F);
    }

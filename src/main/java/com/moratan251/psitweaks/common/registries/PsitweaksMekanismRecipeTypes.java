...
public final class PsitweaksMekanismRecipeTypes {
    private static final DeferredRegister<RecipeType<?>> RECIPE_TYPES =
            DeferredRegister.create(ForgeRegistries.RECIPE_TYPES, Psitweaks.MOD_ID);
    ...
    private PsitweaksMekanismRecipeTypes() {
    }

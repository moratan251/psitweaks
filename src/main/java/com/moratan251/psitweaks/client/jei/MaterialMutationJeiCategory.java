...
public class MaterialMutationJeiCategory implements IRecipeCategory<MaterialMutationJeiRecipe> {
    ...
    private static final int INPUT_X = 34;
    ...
    @Override
    public void draw(MaterialMutationJeiRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY) {

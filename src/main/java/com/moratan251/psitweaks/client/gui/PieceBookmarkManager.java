...
public final class PieceBookmarkManager {
    ...
    private static Set<String> getBookmarkIdSnapshot() {
        List<? extends String> configValues = PsitweaksClientConfig.CLIENT.pieceBookmarks.get();
    ...
    private static void save(Set<String> bookmarkIds) {
        PsitweaksClientConfig.CLIENT.pieceBookmarks.set(new ArrayList<>(bookmarkIds));

...
public class AquaCutterProjectileRenderer extends EntityRenderer<EntityAquaCutterProjectile> {
    ...
    public AquaCutterProjectileRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void render(
            EntityAquaCutterProjectile projectile,
            float entityYaw,
            float partialTick,
            PoseStack poseStack,
    ...
    @Override
    public ResourceLocation getTextureLocation(EntityAquaCutterProjectile projectile) {

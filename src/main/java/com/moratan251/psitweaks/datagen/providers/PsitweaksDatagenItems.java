...
final class PsitweaksDatagenItems {
    private static final List<GeneratedItem> ITEMS = List.of(
            ...
            item("quantum_factor", "Quantum Factor", "クァンタム因子"),
            item("graviton_factor", "Graviton Factor", "グラヴィトン因子"),
            item("hardened_capsule", "Hardened Capsule", "強化カプセル"),
            item("flash_coil", "Flash Coil", "フラッシュコイル"),
            item("flash_chip", "Flash Chip", "フラッシュチップ"),
            item("nano_reactor", "Nano Reactor", "ナノリアクター"),
            item("string_a", "String?", "糸?"),
            item("quantized_plate", "Quantized Plate", "クォンタイズドプレート"),
            item("gravitized_plate", "Gravitized Plate", "グラヴィタイズドプレート"),
            item("unfathomable_component", "Unfathomable Component", "不可思議な機構"),
            ...
            item("program_dry_meteor", "Program: Dry Meteor", "プログラム: ドライミーティア", "program_trick_dry_meteor"),
            ...
            item("program_jump_flex", "Program: Flexible Jump", "プログラム: 柔軟ジャンプ", "program_trick_jump_flex"),
            ...
            item("program_idea_storage", "Program: Ideaspace Storage (WIP)", "プログラム: イデアストレージ (WIP)", "program_trick_idea_storage"),

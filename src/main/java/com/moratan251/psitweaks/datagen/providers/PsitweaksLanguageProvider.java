...
public class PsitweaksLanguageProvider extends LanguageProvider {
    ...
    private void addEnglishTranslations() {
        ...
        add("psi.book.page.psitweaks_material.psycheonic_metal_nugget", "Made by infusing $(item)Heavy Psimetal$(0) with Hypostasis.$(p)Craft nine nuggets into a $(item)Psycheonic Metal Ingot$(0).");
        add("psi.book.page.psitweaks_material.psycheonic_metal_ingot", "Crafted from nine $(item)Psycheonic Metal Nuggets$(0).$(p)Used for transcendent spell bullets, Psycheonic Metal CAD assemblies, and the highest psionic material tier.");
    ...
    private void addJapaneseTranslations() {
        ...
        add("psi.book.page.psitweaks_material.psycheonic_metal_nugget", "$(item)ヘビーサイメタル$(0) にヒュポスタシスを注入して作ります.$(p)9個クラフトすると $(item)プシオニックメタルインゴット$(0) になります.");
        add("psi.book.page.psitweaks_material.psycheonic_metal_ingot", "$(item)プシオニックメタルナゲット$(0) 9個からクラフトします.$(p)超越 tier の術式弾, プシオニックメタル CAD 素体, 最上位のサイオニック素材に使います.");
